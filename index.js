...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let sortedHotelsByPrice = hotels.slice();
  if (pricing === 'low-to-high') {
    sortedHotelsByPrice.sort((hotel1, hotel2) => hotel1.price - hotel2.price);
  } else {
    sortedHotelsByPrice.sort((hotel1, hotel2) => hotel2.price - hotel1.price);
  }
  res.json({ hotels: sortedHotelsByPrice });
});
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let sortedHotelsByRating = hotels.slice();
  if (rating === 'low-to-high') {
    sortedHotelsByRating.sort(
      (hotel1, hotel2) => hotel1.rating - hotel2.rating
    );
  } else {
    sortedHotelsByRating.sort(
  ...
  res.json({ hotels: sortedHotelsByRating });
});
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let sortedHotelsByReviews = hotels.slice();
  if (reviews === 'least-to-most') {
    sortedHotelsByReviews.sort(
      (hotel1, hotel2) => hotel1.reviews - hotel2.reviews
    );
  } else {
    sortedHotelsByReviews.sort(
      (hotel1, hotel2) => hotel2.reviews - hotel1.reviews
    );
  }
  res.json({ hotels: sortedHotelsByReviews });
});
